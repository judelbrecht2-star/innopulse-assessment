/*************************************************************
 * InnoPulse 360 — Corporate backend extension
 * The Growth System
 *
 ...
 * reads to the InnoPulse 360 admin dashboard. The existing public
 ...
 *  6) Put the web app URL into 360-config.js (frontend), e.g.:
